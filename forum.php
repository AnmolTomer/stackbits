...
<?php if( !empty($user) ): ?>
  ...
  <div class='sidebar'>
    ...
    <ul class='nav'>
      ...
      <li><a href="helpline.php">Helpine</a></li>
      <li>
      ...
      <li>
        <a  class='active' href="forum.php">Forums</a>
      </li>
      <li>
  ...
  <div class='content isOpen'>
    <a class='button'></a>
    <center><iframe src="forum/index.php" height=1000 width=700></iframe></center>
  </div>
</div>
