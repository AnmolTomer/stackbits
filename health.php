...
<head>
  <meta charset="UTF-8">
  <title>StackBits|Be Healthy!</title>
...
<?php if( !empty($user) ): ?>
  ...
  <div class='sidebar'>
    ...
    <ul class='nav'>
      ...
      <li>
        <a  class='active' href="health.php">Be Healthy :D</a>
      </li>
      <li>
  ...
  <div class='content isOpen'>
    <a class='button'></a>
    <center>
	<br><h2><b>Real Time Suggestions based on Air Quality Index of your location:</b></h2><br><iframe src="health/index.php" height=2200 width=625></iframe></center>
  </div>
</div>
