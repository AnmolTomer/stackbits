...
<head>
  <meta charset="UTF-8">
  <title>StackBits|Pollution</title>
...
<?php if( !empty($user) ): ?>
  ...
  <div class='sidebar'>
    ...
    <ul class='nav'>
      ...
      <li>
        <a class='active' href="pollution.php">Pollution Statistics</a>
      </li>
      <li>
  ...
  <div class='content isOpen'>
    <a class='button'></a>
    <center><iframe src="donut/index.html" height=1000 width=700></iframe>
	<br><h2>Real Time AIQ Analysis</h2><br><iframe src="ok/index.php" height=298 width=810></iframe></center>
  </div>
</div>
